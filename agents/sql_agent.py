...
def create_sql_agent():
    ...
    prompt = ChatPromptTemplate.from_messages([
        ...
        - You must ALWAYS generate a valid MySQL query.
        - Never answer questions directly.
        - Always call query_sql_database with a SQL query string.
        - Never return JSON or structured objects.
        - Never summarize results without executing the SQL query.
        - When counting rows, use COUNT(*).

        Workflow:
        1. Convert the user request into SQL.
        2. Execute the SQL using query_sql_database.
        3. Return the result.
        """),
        ("human", "{input}"),
